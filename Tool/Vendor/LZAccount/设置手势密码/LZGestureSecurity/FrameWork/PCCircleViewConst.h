 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(254,217,83,1)
...
#define gestureDefaultImagePath [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/gestureDefaultImage.png"]
